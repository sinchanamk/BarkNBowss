...
void main() =>
  runApp(MaterialApp(home:   accessProd()));   
class accessProd extends StatefulWidget {
  @override
  _accessProdState createState() => _accessProdState();
}
class _accessProdState extends State< accessProd>
{
  String _chosenValue;
  Widget build(BuildContext context) {
   //int _itemCount;
    return Scaffold(appBar:AppBar(leading: IconButton(icon: Icon(Icons.arrow_back, color: Colors.black),onPressed: () => Navigator.of(context).pop(),),
        ...
        text: TextSpan(text: "Pet Toys & accessories..",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w900,
   ...
   children: <Widget>[ Column(children:[ Container(
         ...
         child: PhotoView(
               imageProvider: AssetImage('lib/assets/m4.png',),),),
            Container(height: 270.0,color: Colors.white,
          width: 340.0,padding:EdgeInsets.only(right: 10.0,left: 7.0) ,
         child: PhotoView(
               imageProvider: AssetImage('lib/assets/a15.png'),),),
...
Row(
      ...
      Container(
       ...
       Row(
        ...
        padding: EdgeInsets.only(left: 20.0,bottom: 10.0),
          child:Image.asset('lib/assets/a14.png'),
          ),  ]),
            ]),
  Column(children: [
 ...
 Container(
                child: Image.asset('lib/assets/a2.png'),
              ),
 Container(
         ...
         Row(children:[
           Column(children:[
            Container(height: 210.0,
              child: Image.asset('lib/assets/a12.png'),
            ),
            Container(
